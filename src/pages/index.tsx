...
const LoadableHowItWorks = loadable(
    () => import(/* webpackChunkName: "how-it-works",
...
const LoadablePractice = loadable(
    () => import(/* webpackChunkName: "practice",
...
const LoadableResources = loadable(
    () => import(/* webpackChunkName: "resources",
...
export { Home, HowItWorks, Practice, Resources, NotFound };
