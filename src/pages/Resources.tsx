    ...
    return (
        <>
            ...
            <div className={styles.suggestion}>
                <p className={styles.suggestion__text}>
                    Want to add a resource to the list? Open an issue on GitHub and make a
                    suggestion!
                </p>
                <a
                    href="https://github.com/AnOrdinaryUsername/Bits/issues"
                    target="_blank"
                    rel="noopener noreferrer"
